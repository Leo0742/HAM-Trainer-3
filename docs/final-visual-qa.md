...
В финальном корректирующем проходе повторно созданы только `08-topic-reference-1440-light-large.png` и `09-topic-expanded-1440-light-large.png`: collapsed-строки стали заметно компактнее и показывают только номер, вопрос и официальный ответ; объяснение остаётся доступно после раскрытия.
